...
define( 'WPSA_PSI_API_KEY', 'AIzaSyAs5Mxrt2MhsrlOj6S1p3I0XcIbxjqEI5w' );
...
add_action( 'admin_menu', function() {
    add_management_page(
        'Speed Analyzer WP ' . WPSA_VERSION,
        'Speed Analyzer WP',
        'manage_options',
        'speed-analyzer-wp',
...
add_action( 'admin_enqueue_scripts', function( $hook ) {
    ...
    wp_enqueue_style(
        ...
        [],
        file_exists( $css ) ? filemtime( $css ) : WPSA_VERSION
    );
    wp_enqueue_script(
        'wpsa-admin-scripts',
        plugin_dir_url( __FILE__ ) . 'admin-scripts.js',
        [ 'jquery' ],
        file_exists( $js ) ? filemtime( $js ) : WPSA_VERSION,
        true
    );
    ...
    <div class="wrap">
      <h1 class="wpsa-header">
        ...
        <div class="wpsa-header-info">
          ...
          <small class="wpsa-version"><?php echo esc_html( WPSA_VERSION ); ?></small>
